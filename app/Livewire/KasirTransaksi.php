...
class KasirTransaksi extends Component
{
    ...
    {
        if ($this->tipe_harga == 'grosir') return $produk->harga_grosir;
        if ($this->tipe_harga == 'semi_grosir') return $produk->harga_semi_grosir;
    ...
    public function simpanTransaksi()
    {
        ...
        // --- SELESAI LOGIKA KODE TRANSAKSI OTOMATIS ---
