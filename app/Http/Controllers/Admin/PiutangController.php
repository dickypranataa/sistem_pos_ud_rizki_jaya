...
{
    /**
     * Daftar piutang — Admin melihat semua.
     */
    public function index(Request $request)
    {
        ...
        return view('admin.piutang.index', compact('piutangs', 'status', 'search'));
    }

    /**
     * Detail piutang — riwayat cicilan & perpanjangan.
     */
    ...
    /**
     * Simpan cicilan/pelunasan piutang.
     */
    ...
    /**
     * Simpan perpanjangan tempo — tersedia untuk Admin & Kasir.
     */
    public function storePerpanjangan(Request $request, $id)
    {
        ...
        if ($piutang->status === 'lunas') {
            return back()->with('error', 'Piutang ini sudah lunas, tidak perlu diperpanjang.');
        }
