<header class="bg-white border-b border-gray-100 h-16 flex items-center justify-between px-5 z-10 flex-shrink-0 shadow-sm">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-sm font-bold text-gray-900 hidden md:block">Panel Administrator</h1>
            <p class="text-xs text-gray-400 hidden md:block">Selamat datang kembali, {{ Auth::user()->name }}!</p>
        </div>
    </div>
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.away="open = false"
                ...
                <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 bg-gray-50/80">
                    ...
                    @if(auth()->user()->unreadNotifications->count() > 0)
                        <a href="{{ route('notifikasi.readAll') }}" class="text-xs text-blue-500 hover:text-blue-700 font-semibold transition-colors">Tandai dibaca</a>
                    @endif
                </div>
        ...
        <div class="relative" x-data="{ open: false }">
            <button @click="open = !open"
                ...
                <div class="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white text-xs font-bold shadow-sm flex-shrink-0">
            ...
            <div x-show="open"
                ...
                <div class="px-1.5">
                    <a href="{{ route('profile.edit') }}"
                        class="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-xl transition-colors duration-150 font-medium">
