<aside class="w-64 bg-white border-r border-gray-200 hidden md:block flex-shrink-0">
    ...
    <nav class="mt-5 px-4 space-y-2">
        ...
        <a href="{{ route('admin.user.index') }}"
            ...
            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                viewBox="0 0 16 16">
                <path
        ...
        <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-4 mb-1 pl-4">Transaksi & Laporan
        </div>
