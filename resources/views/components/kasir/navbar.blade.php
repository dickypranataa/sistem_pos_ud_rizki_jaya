<header class="bg-white shadow h-16 flex items-center justify-between px-6 z-10">
    ...
    <div class="flex items-center">
        <button id="btn-hamburger" class="md:hidden text-gray-500 hover:text-gray-700 focus:outline-none">
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.away="open = false"
                ...
                <div class="flex justify-between items-center px-4 py-3 bg-gray-50 border-b">
                    ...
                    @if(auth()->user()->unreadNotifications->count() > 0)
                        <a href="{{ route('notifikasi.readAll') }}" class="text-xs text-blue-500 hover:text-blue-700">Tandai
                            sudah dibaca</a>
                    @endif
                </div>
