...
<div class="mb-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
    <form action="{{ route('admin.transaksi.index') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-center">
        ...
        <div class="flex gap-2 w-full md:w-auto mt-2 md:mt-0">
            ...
            <a href="{{ route('admin.transaksi.export', request()->query()) }}" class="w-full md:w-auto bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-5 rounded-lg text-center transition font-semibold text-sm shadow-sm flex items-center justify-center gap-2">
